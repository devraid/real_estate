...
const UIModalWrapper = ({children}:any) => {
    return (
		<div className="ui-modal-wrapper flex justify-center md:items-center w-screen h-screen fixed top-0 left-0 p-5 bg-[rgba(255,255,255,0.1)] overflow-y-auto">
			...
			<button className="appearance-none outline-none text-base text-black absolute top-5 right-5">
				<svg className="transition-all fill-black hover:fill-green-5 h-5 w-5"><path d="M12.018 10 21 18.554 19.481 20 10.5 11.446 1.518 20 0 18.554 8.981 10 0 1.446 1.518 0 10.5 8.554 19.481 0 21 1.446z"/></svg>
			</button>
				{children}
			</div>
      </div>
